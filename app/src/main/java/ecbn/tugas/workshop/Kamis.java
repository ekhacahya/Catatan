 ...
 */
public class Kamis extends android.app.Fragment {
    DBHelper dbHelper;
    View rootView;
    private int id=-1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView =  inflater.inflate(R.layout.kamis, container, false);
    ...
    private void view() {
        ...
        try{
            cursor = db.rawQuery("SELECT * FROM catatan where hari='Kamis'",null);
